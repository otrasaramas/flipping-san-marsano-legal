# Ficha de seguimiento — FLIP 01 · Apto 9844 · Matrícula 01N-5433424
...
**Etapa actual:** 🔧 Remodelación + saneamiento del folio
**Semáforo de papeles:** 🔴 (las 4 limitaciones siguen vigentes en el folio)
...
| Dato | Valor |
|---|---|
| Inmueble | Apto 9844, Torre 7, El Tirol 3, Medellín |
| Matrícula | **01N-5433424** |
| Vendedora | María Villaly Montoya Serna |
| Estado civil | **Soltera, separada de Wilson Betancur** ⚠️ (corregido en el otrosí; el poder trae declaración juramentada de unión vigente que es falsa → requiere escritura aclaratoria) |
| Apoderado / comprador | Nicolás (comparece en doble condición) |
| ORIP | Medellín Norte |
| Notaría del poder | Notaría Primera de Bello — E.P. del **30-jun-2026** |

## 2) El reloj

| Hito | Fecha planeada | Fecha real | Estado |
|---|---|---|---|
| Promesa de compra | — | **13-may-2026** | ✅ |
| Entrega física | — | **26-jun-2026** | ✅ |
| Poder especial de María | — | **30-jun-2026** | ✅ |
| Folio limpio (registrado) | por definir | — | ⬜ |
| Remodelación terminada | [completar] | — | ⬜ |
| **Publicar en venta** | **15-ago-2026** | — | ⬜ |
| Comprador / promesa de venta | ~sep-2026 | — | ⬜ |
| Escritura de venta | **~13-oct-2026** | — | ⬜ |
| Registro y pago del saldo a María | al escriturar | — | ⬜ |

**Días corridos desde la promesa:** **79 de 150.**
**Fecha límite para publicar: 15-ago-2026** (quedan ~15 días).

> La fecha de la escritura de venta la determina **el comprador (Nicolás)**, según
> la cláusula SÉPTIMA del otrosí — pero el saneamiento tiene que estar listo antes.

## 3) Papeles — limitaciones del folio 01N-5433424
...
| Qué | Dónde | Fecha radicado | Turno | Estado |
|---|---|---|---|---|
| Poder especial María → Nicolás | VUR / Notaría 1ª de Bello | 30-jun-2026 | [ ] | radicado ✅ |
| Retiro ISVIMED del 9844 | ISVIMED / ORIP | — | — | ⬜ **por confirmar** |

## 4) Documentos de la operación

| Documento | Instrumento | Estado | Archivo |
|---|---|---|---|
| Promesa de compraventa (13-may-2026) | Privado | ✅ | — |
| Otrosí a la promesa | Privado | ✅ definitivo | `Otrosi-Promesa-DEFINITIVO.docx` |
| Poder especial María → Nicolás | Escritura pública | ✅ 30-jun-2026 | `analisis-poder-firmado.md` |
| **Escritura aclaratoria del estado civil** | Escritura pública | ⬜ **pendiente** | — |
| Cancelación patrimonio + levantamiento afectación | Escritura pública | ⬜ | `plantillas/04-...` |
| Cesión de posición contractual | | ⬜ | `evitar-doble-escrituracion.md` |
...
|---|---|---|
| Precio de compra a María | **$121.000.000** | |
| Abono 1 — promesa (13-may-2026) | $10.000.000 | ✅ |
...
|---|---|---|---|
| **Wilson hospitalizado** — su firma es indispensable para el levantamiento de la afectación | 🔴 bloquea la venta | Si está lúcido: notario en la clínica o poder especial allí. Si no: vía judicial (meses). **Decidir ya.** | ⬜ |
| **Retiro de ISVIMED del 9844 sin confirmar** | 🔴 bloquea la transferencia | Confirmar radicado; si no existe, gestionarlo (ver `plantillas/08-...`, derecho de petición) | ⬜ |
| **Declaración juramentada falsa** en el poder (unión vigente) | 🟡 nulidad / reparo notarial | Escritura aclaratoria del estado civil | ⬜ |
| **Caja**: $113M ya salieron + remodelación; solo entra al vender | 🟡 | No comprometer el flip 2 sin verificar liquidez | ⬜ |
| Tiempos de registro en la ORIP | 🟡 | Radicar cuanto antes, seguimiento semanal, colchón en las fechas | ⬜ |
...
| 26-jun-2026 | Entrega física del apartamento + pago de $30.000.000. |
| 13-may-2026 | Firma de la promesa de compraventa + pago de $10.000.000. |
