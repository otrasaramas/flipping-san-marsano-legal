# Análisis jurídico y saneamiento — FLIP 2 (Martha, El Tirol apto 9840)

> Apoyo informativo, **no es asesoría legal**. Matrícula **01N-5433420**.
> Estado a 30-jun-2026.

## Resumen
Estructura **idéntica al flip 1**: es una **VIP con subsidio** (Resolución 710 de
2017 de ISVIMED), con las mismas cuatro limitaciones por sanear, más servidumbres
de servicios públicos (que normalmente **no impiden** vender).

## Limitaciones a sanear (folio 01N-5433420)
| Anot. | Limitación | Quién levanta / firma |
|---|---|---|
| 008 | Prohibición de transferencia (10 años, Ley 1537/2012) | **Retiro de ISVIMED** (radicado en Ventanilla Única, **pendiente**) |
| 007 | Derecho de preferencia (ISVIMED/FONVIVIENDA) | Igual al anterior |
| 009 | Patrimonio de familia (Martha + hijos) | **Martha + los hijos beneficiarios** |
| 010 | Afectación a vivienda familiar | **Martha + Luis Eduardo Chavarría Carvajal (C.C. 70.576.777)** |

> El plazo de 10 años corre desde el registro (07-04-2017) → hasta **abril de
...
1. **Levantamiento de afectación + cancelación de patrimonio** (Martha + hijos +
   Luis Eduardo Chavarría) — escritura pública, **registrar** después.
