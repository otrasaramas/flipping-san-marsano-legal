# CONTRATO DE MUTUO (PRÉSTAMO DE DINERO) CON INTERÉS

> ⚠️ **BORRADOR — apoyo informativo, NO asesoría legal.** Conviene que lo revise un
> abogado y, para mayor fuerza, **autenticar las firmas ante notario**. Campos
> entre `[ ]` por completar.
...
celebrado el presente contrato de mutuo con interés, que se regirá por las
siguientes cláusulas:

**PRIMERA. OBJETO Y MONTO.** LA MUTUANTE entrega a EL MUTUARIO, a título de mutuo
(préstamo de consumo), la suma de **SESENTA MILLONES DE PESOS M/CTE
...
Superintendencia Financiera), sin perjuicio de las demás acciones legales.

**SÉPTIMA. PREPAGO.** EL MUTUARIO podrá pagar anticipadamente, total o
parcialmente, **sin sanción**, liquidándose los intereses solo por el tiempo
efectivamente transcurrido.

**OCTAVA. CLÁUSULA ACELERATORIA.** El incumplimiento en el pago del capital o de los
intereses hará exigible la **totalidad de la obligación como de plazo vencido**, sin
necesidad de requerimiento, al que las partes renuncian.

**NOVENA. MÉRITO EJECUTIVO.** Las partes acuerdan que este contrato contiene una
obligación **clara, expresa y exigible** y presta **mérito ejecutivo** (Art. 422 del
Código General del Proceso), por lo que podrá cobrarse ejecutivamente.

**DÉCIMA. GASTOS.** Los gastos de autenticación y los que genere el cobro (en caso
de incumplimiento) estarán a cargo de **[EL MUTUARIO / según corresponda]**.

**DÉCIMA PRIMERA. DOMICILIO Y LEY APLICABLE.** Para todos los efectos, el domicilio
